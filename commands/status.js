...
module.exports = {
	...
	async execute(interaction, guild, member, perm) {
		...
		let lastDependentRoleAuditDiff = new Date(now - global.lastDependentRoleAudit);
		...
		let embed = {
			...
			fields: [
				...
				{ name: 'Last Dependent Role Audit', value: `${lastDependentRoleAuditDiff.getMinutes()} minutes, ${lastDependentRoleAuditDiff.getSeconds()} seconds ago` },
