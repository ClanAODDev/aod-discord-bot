			...
			case 'kick': {
				...
				try {
					...
					if (confirmation.customId === 'confirm_user_kick') {
						...
						await global.sendGlobalNotification(interaction, `${targetMember} has been kicked by ${member} for: ${reason}`);
			...
			case 'ban': {
				...
				try {
					...
					if (confirmation.customId === 'confirm_user_ban') {
						...
						await global.sendGlobalNotification(interaction, `${userToBan} has been banned by ${member} for: ${reason}`);
